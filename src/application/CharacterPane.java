...
public class CharacterPane extends HBox {
	...
	public CharacterPane() {
		...
		CharacterCard b = new CharacterCard("Red", 200, 10, 100, 15, "file:res/redbomb.png","file:res/red.png");
		CharacterCard c = new CharacterCard("Blue", 150, 5, 100, 10,"file:res/bluebomb.png", "file:res/blue.png");
