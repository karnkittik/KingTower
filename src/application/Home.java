...
public class Home extends Application {
	...
	public void start(Stage primaryStage) {
		...
		Hyperlink setting = new Hyperlink("SETTINGS"); 
		...
		back.setLayoutX(0);
		back.setLayoutY(740);
		back.setPrefWidth(600);
		back.setAlignment(Pos.CENTER);
		back.setStyle("-fx-border-width : 0;" +
				"-fx-font-family : Thonburi;" + 
				"-fx-font-size : 25;" + 
				"-fx-text-fill : white;");
		...
		setting.setStyle(" -fx-border-width : 0;" + 
				"-fx-font-family : Thonburi;" +
				"-fx-font-size : 40;" + 
				"-fx-text-fill : red;");
